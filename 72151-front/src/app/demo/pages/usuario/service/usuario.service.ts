...
export class UsuarioService {
  ...
  guardarUsuarioNuevo(usuario: Usuario) : Observable<UsuarioRs>  {    
    return this.backendService.post(environment.apiUrl, this.api, "guardar", usuario);
  }

  actualizarUsuario(usuario: Usuario): Observable<UsuarioRs>  {    
    return this.backendService.put(environment.apiUrl, this.api, "actualizar", usuario);
  }
